...
class WiseCat(OpenAICompatibleProvider):
    ...
    # Mapping from OpenAI-style model names to WiseCat model names
    MODEL_MAPPING = {
        "gpt-3.5-turbo": "chat-model-small",
        "gpt-4": "chat-model-large",
        "gpt-4-turbo": "chat-model-reasoning",
    }
    ...
    def __init__(
        ...
        Args:
            api_key: Not used by WiseCat but included for compatibility
            timeout: Request timeout in seconds
            browser: Browser to emulate in user agent
        """
        self.api_key = api_key  # Not used by WiseCat but kept for interface compatibility
